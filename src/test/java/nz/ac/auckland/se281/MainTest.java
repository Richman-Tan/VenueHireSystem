...
public class MainTest {
  ...
  public static class Task1 extends CliTest {
    ...
    @Test
    public void T1_09_inbetween_2_and_9_venues() throws Exception {
      runCommands(
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
    ...
    @Test
    public void T1_010_invalid_capacity_notanumber() throws Exception {
      runCommands(
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
    ...
    @Test
    public void T1_011_invalid_hirefee_negative() throws Exception {
      runCommands(
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
    ...
    @Test
    public void T1_012_invalid_venueName() throws Exception {
      runCommands(
          CREATE_VENUE,
          "''",
          "FFH",
    ...
    @Test
    public void T1_013_second_venue_saved() throws Exception {
      runCommands( //
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
    ...
    @Test
    public void T1_014_same_code_different_name() throws Exception {
      runCommands( //
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
    ...
    @Test
    public void T1_015_leading_zeros() throws Exception {
      runCommands( //
          CREATE_VENUE,
          "'Frugal Fiesta Hall'",
          "FFH",
      ...
      assertContains("Successfully created venue 'Comfy Corner Events Centre' (CCEC).");
      assertContains("There are two venues in the system:");
      assertContains("Frugal Fiesta Hall (FFH) - 690 people - $150 base hire fee");
      assertContains("Comfy Corner Events Centre (CCEC) - 5 people - $2312312 base hire fee");
    }
  ...
  public static class Task2 extends CliTest {
    ...
    @Test
    public void T2_16_print_bookings_venue_without_bookings() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
              "31/12/2024", //
              MAKE_BOOKING,
              options("GGG", "31/12/2024", "client001@email.com", "230"),
              MAKE_BOOKING,
              options("GGG", "01/01/2025", "client001@email.com", "230"),
              PRINT_BOOKINGS,
              "GGG",
              PRINT_BOOKINGS,
              "FFH",
  ...
  public static class Task3 extends CliTest {
    ...
    @Test
    public void T3_16_invoice_details_show_customer_emails() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
              "03/02/2024", //
              MAKE_BOOKING,
              options("LLH", "27/07/2024", "client001@email.com", "850"),
              SET_DATE,
              "04/02/2024",
              ADD_CATERING,
              "HUD14D8O",
  ...
  public static class YourTests extends CliTest {
    ...
    public void T4_02_add_your_own_tests_as_needed() throws Exception {
      runCommands(
          ...
          "150", //
          MAKE_BOOKING,
          options("FFF", "27/02/2024", "client001@email.com", "70"));

      assertContains("Booking not made: there is no venue with code 'FFF'.");
      assertDoesNotContain("Successfully created booking", true);
    }
  }
